...
class TestGetGroupUsers(TestCase):
    def test_a_all(self):
        users = getGroupUsers(PARAMETERS.get("domainGroup", "myDCGroup"), PARAMETERS.get("domainController", "localhost"))
    ...
    def test_c_fail(self):
        self.assertRaises(MSADQueryException, getGroupUsers, PARAMETERS.get("domainController", "localhost"), "myDCGroup")
